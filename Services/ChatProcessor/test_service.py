"""
Simple test script for ChatProcessor service.

This script tests the service components independently without requiring
full RabbitMQ/Ollama setup.
"""
...
async def test_message_models():
    ...
    # Test UserPromptReceivedMessage
    print("\n1. Testing UserPromptReceivedMessage...")
    prompt_msg = UserPromptReceivedMessage(
        conversation_id=123,
    ...
    # Test BotResponseCreatedMessage
    print("\n2. Testing BotResponseCreatedMessage...")
    response_msg = BotResponseCreatedMessage(
        conversation_id=123,
...
async def main():
    ...
    # Test message models (always works)
    await test_message_models()

    # Test Ollama service (requires Ollama running)
